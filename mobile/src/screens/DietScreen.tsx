...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#1e293b', marginBottom: 12, textAlign: 'left' },
  ...
  stepTitle: { fontSize: 15, fontWeight: '600', color: '#1e293b', textAlign: 'left' },
  stepDesc: { fontSize: 12, color: '#64748b', marginTop: 2, textAlign: 'left' },
  ...
  optionTitle: { fontSize: 16, fontWeight: '600', color: '#1e293b', textAlign: 'left' },
  optionTitleSelected: { color: '#fff' },
  optionDesc: { fontSize: 12, color: '#64748b', marginTop: 2, textAlign: 'left' },
  ...
  cardText: { fontSize: 14, color: '#475569', lineHeight: 20, textAlign: 'left' },
  ...
  mealOptionLabel: { fontSize: 11, fontWeight: '600', color: '#f59e0b', marginBottom: 4, textAlign: 'left' },
  mealName: { fontSize: 15, fontWeight: '600', color: '#1e293b', marginBottom: 4, textAlign: 'left' },
  mealDesc: { fontSize: 13, color: '#64748b', lineHeight: 18, marginBottom: 6, textAlign: 'left' },
  mealMacros: { flexDirection: 'row', gap: 10 },
  mealMacroText: { fontSize: 11, color: '#94a3b8', fontWeight: '500' },
  mealBenefits: { fontSize: 12, color: '#22c55e', marginTop: 4, fontStyle: 'italic', textAlign: 'left' },
  supplementItem: { borderTopWidth: 1, borderTopColor: '#f1f5f9', paddingTop: 10, marginTop: 8 },
  supplementName: { fontSize: 15, fontWeight: '600', color: '#1e293b', textAlign: 'left' },
  supplementDetail: { fontSize: 13, color: '#64748b', marginTop: 2, textAlign: 'left' },
  supplementFoods: { fontSize: 12, color: '#22c55e', marginTop: 4, textAlign: 'left' },
  ...
  scientificText: { fontSize: 11, color: '#8b5cf6', lineHeight: 16, flex: 1, textAlign: 'left' },
  macroRangeText: { fontSize: 11, color: '#94a3b8', marginTop: 4, fontWeight: '500', textAlign: 'left' },
  customCaloriesCard: { backgroundColor: '#fff', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#e2e8f0', marginTop: 6 },
  customCaloriesLabel: { fontSize: 14, fontWeight: '600', color: '#1e293b', marginBottom: 8, textAlign: 'left' },
  customCaloriesInput: { borderWidth: 1.5, borderColor: '#cbd5e1', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, color: '#0f172a', backgroundColor: '#f8fafc', textAlign: 'left' },
  customCaloriesHint: { fontSize: 12, color: '#64748b', marginTop: 8, textAlign: 'left' },
  tipItem: { borderTopWidth: 1, borderTopColor: '#f1f5f9', paddingTop: 10, marginTop: 8 },
  tipCondition: { fontSize: 15, fontWeight: '600', color: '#1e293b', marginBottom: 4, textAlign: 'left' },
  tipAdvice: { fontSize: 13, color: '#475569', marginBottom: 2, textAlign: 'left' },
  ...
  savedCardTitle: { fontSize: 15, fontWeight: '600', color: '#1e293b', textAlign: 'left' },
  savedCardDate: { fontSize: 12, color: '#94a3b8', marginTop: 2, textAlign: 'left' },
});
