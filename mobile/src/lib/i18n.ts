...
// The synchronous RTL force was removed to prevent layout ping-ponging.
...
const resources = {
  ar: {
    translation: {
      ...
      settings: 'الإعدادات',
      dateCalendar: 'نوع التاريخ',
      dateCalendarSelect: 'اختر نوع التاريخ',
      gregorian: 'ميلادي',
      hijri: 'هجري',
      login: 'تسجيل الدخول',
      logout: 'تسجيل الخروج',
      ...
      targetLabValue: 'القيمة المستهدفة في الفحص',
      savePlan: 'حفظ الخطة',
      newPlan: 'خطة جديدة',
  ...
  en: {
    translation: {
      ...
      dateCalendarSelect: 'Choose date type',
      gregorian: 'Gregorian',
      hijri: 'Hijri',
      login: 'Login',
      logout: 'Logout',
      ...
      targetLabValue: 'Target Lab Value',
      savePlan: 'Save Plan',
      newPlan: 'New Plan',
