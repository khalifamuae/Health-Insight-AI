  ...
  ar: {
    translation: {
      ...
      subscription: {
        ...
        autoRenew: 'يتم الدفع عبر حساب Apple أو Google الخاص بك. يتجدد الاشتراك تلقائياً ما لم يتم إلغاؤه قبل ٢٤ ساعة من نهاية الفترة الحالية.',
        ...
        saveYearly: 'وفّر ٤٠.٨٨$ مع الاشتراك السنوي'
      },
      reminders: {
        title: 'التذكيرات',
        recheck: 'إعادة الفحص',
