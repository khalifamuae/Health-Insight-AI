...
const resources = {
  en: {
    translation: {
      ...
      nutritionDisclaimer: "This is general educational information only and does not constitute a medical consultation. You should consult a certified nutritionist or dietitian for a personalized plan tailored to your health condition.",
  ...
  ar: {
    translation: {
      ...
      nutritionDisclaimer: "هذه نصائح تثقيفية عامة فقط ولا تعتبر استشارة طبية. يجب استشارة خبير تغذية معتمد للحصول على نظام غذائي مخصص يتناسب مع حالتك الصحية.",
