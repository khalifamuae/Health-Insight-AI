...
const resources = {
  en: {
    translation: {
      ...
      questProteinTitle: "What protein do you prefer?",
      questProteinSubtitle: "This helps us customize your meals with your favorite protein source",
      proteinFish: "Fish",
      proteinFishDesc: "Rich in omega-3, great for heart and brain health",
      proteinChicken: "Chicken",
      proteinChickenDesc: "Lean protein, versatile and easy to prepare",
      proteinMeat: "Red Meat",
      proteinMeatDesc: "Rich in iron and B12, great for energy and muscle",
      proteinMixed: "Mixed (All Types)",
      proteinMixedDesc: "Variety of fish, chicken, and meat for balanced nutrition",
      questPreferenceTitle: "What type of meals do you prefer?",
      questPreferenceSubtitle: "Choose what suits you, you can browse the menu later",
  ...
  ar: {
    translation: {
      ...
      questProteinSubtitle: "يساعدنا ذلك على تخصيص وجباتك بمصدر البروتين المفضل لديك",
      proteinFish: "أسماك",
      proteinFishDesc: "غنية بأوميغا-3، ممتازة لصحة القلب والدماغ",
      proteinChicken: "دجاج",
      proteinChickenDesc: "بروتين خفيف، متعدد الاستخدامات وسهل التحضير",
      proteinMeat: "لحوم حمراء",
      proteinMeatDesc: "غنية بالحديد وفيتامين ب12، ممتازة للطاقة والعضلات",
      proteinMixed: "متنوع (جميع الأنواع)",
      proteinMixedDesc: "تنوع بين الأسماك والدجاج واللحوم لتغذية متوازنة",
      questPreferenceTitle: "أي نوع من الوجبات تفضل؟",
      questPreferenceSubtitle: "اختر ما يناسبك وستتمكن من تصفح المنيو لاحقاً",
