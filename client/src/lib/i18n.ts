...
const resources = {
  en: {
    translation: {
      ...
      freeTrial: "Start with 15-day free trial",
      autoRenewDisclosure: "Subscription automatically renews unless canceled at least 24 hours before the end of the current period. Payment will be charged to your iTunes/Google Play account at confirmation of purchase. You can manage and cancel your subscription in your account settings.",
  ...
  ar: {
    translation: {
      ...
      freeTrial: "ابدأ بتجربة مجانية 15 يوم",
      autoRenewDisclosure: "الاشتراك يتجدد تلقائياً ما لم يتم إلغاؤه قبل 24 ساعة على الأقل من نهاية الفترة الحالية. يتم خصم المبلغ من حساب iTunes/Google Play عند تأكيد الشراء. يمكنك إدارة وإلغاء اشتراكك من إعدادات حسابك.",
      ...
      nutritionDisclaimer: "هذا النظام الغذائي مقدّم لأغراض التعليم والتوعية فقط، ولا يُعتبر استشارة طبية أو تشخيصاً أو علاجاً. لا تتحمل BioTrack AI أي مسؤولية عن أي قرارات تُتخذ بناءً على هذه المعلومات. يُرجى دائماً مراجعة طبيبك المختص أو أخصائي تغذية معتمد قبل إجراء أي تغييرات على نظامك الغذائي، خاصةً إذا كنت تعاني من أمراض مزمنة أو تتناول أدوية. صحتك وسلامتك هي أولويتنا.",
